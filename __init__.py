...
from boxshrink.scripts import (IoU, check_box_coordinates,
                               ...
                               get_image_and_segmentation_sets, get_min_max_x,
                               get_min_max_y, get_smallest_imagesize_in_folder,
                               get_value_of_tag, import_dataset,
                               infer_all_bboxes, infer_bounding_boxes,
                               investigate_example, label_colors,
                               resize_images_in_folder,
                               return_batch_information,
                               return_files_in_directory, rgb_to_mask,
                               span_columns, span_rows, tools,
                               train_test_val_split, visualize, visualize_mask,
...
__all__ = ['IoU', 'check_box_coordinates', 'copy_images_to_directories',
           ...
           'rgb_to_mask', 'scripts', 'span_columns', 'span_rows', 'tools',
           'train_test_val_split', 'visualize', 'visualize_mask', 'voc_legacy',
           'voc_tools']

from boxshrink import scripts

from boxshrink.scripts import (Colonoscopy_Dataset, IoU, alphanum_key,
                               check_box_coordinates, config,
                               copy_images_to_directories,
                               create_class_color_code_csv, create_dataset,
                               create_superpixel_mask, crf, dataset,
                               decode_segmap, drop_color_in_image,
                               ...
                               get_image_and_segmentation_sets, get_min_max_x,
                               get_min_max_y, get_smallest_imagesize_in_folder,
                               get_value_of_tag, human_sort, img_transform,
                               import_dataset, infer_all_bboxes,
                               infer_bounding_boxes, jaccard_crf, label_colors,
                               pass_pseudomask_or_ground_truth,
                               process_batch_crf, resize_images_in_folder,
                               return_batch_information,
                               return_files_in_directory, rgb_to_mask,
                               span_columns, span_rows, superpixels, tools,
                               train_test_val_split, tryint, visualize,
                               visualize_mask, visualize_superpixels,
                               voc_legacy, voc_tools,)
...
__all__ = ['Colonoscopy_Dataset', 'IoU', 'alphanum_key',
           ...
           'return_files_in_directory', 'rgb_to_mask', 'scripts',
           'span_columns', 'span_rows', 'superpixels', 'tools',
...
from boxshrink.scripts import (ACTIVATION, BASE_DIR, BATCH_SIZE,
                               BEST_MODEL_DIR, CHECKPOINT_MODEL_DIR, CLASSES,
                               Colonoscopy_Dataset, DATA_DIR, DECODER, DEVICE,
                               ENCODER, ENCODER_WEIGHTS, EVAL_ON_MASKS,
                               EXPORT_BEST_MODEL, EXPORT_CSV_DIR, GAMMA,
                               IOU_THRESHOLD, IoU, LEARNING_RATE,
                               LEARNING_RATE_SCHEDULING, LOSS,
                               MASK_OCCUPANCY_THRESHOLD, MODE, N_EPOCHS,
                               OPTIMIZER, PER_X_BATCH, PER_X_EPOCH,
                               PER_X_EPOCH_PLOT, ResnetFeatureExtractor,
                               SCHEDULE_TYPE, START_EPOCH, STATE, STEP_SIZE,
                               TRAINING_INPUT, WEIGHT_DECAY, alphanum_key,
                               check_box_coordinates, config,
                               copy_images_to_directories,
                               create_class_color_code_csv, create_dataset,
                               create_superpixel_mask, crf, dataset,
                               decode_segmap, drop_color_in_image, embeddings,
                               export_crf_masks_for_train_data, export_dataset,
